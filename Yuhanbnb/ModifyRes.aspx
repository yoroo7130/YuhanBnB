<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyRes.aspx.cs" Inherits="ModifyRes" %>
...
<form id = "form1" runat="server"> 
    <div class="wrapper" ><h1 style="color:black; text-align:center; margin-bottom:40px;"><a href="index.aspx"></a></h1>
        ...
        <asp:TableRow>
          <asp:TableHeaderCell><div class="head-cell"><span class="empha"></span>숙소주소</div></asp:TableHeaderCell>
            <asp:TableCell>
                 <div class="col-cell">
                     <asp:TextBox ID="resaddr" runat="server" CssClass="MS_input_txt normal-input" MaxLength="100" ></asp:TextBox>
                </div>
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                 <div class="col-cell">
                     <asp:TextBox ID="resevt" runat="server" CssClass="MS_input_txt normal-input" MaxLength="150" ></asp:TextBox>
    ...
    <asp:TableRow>
            ...
            <asp:TableCell>
                 <div class="col-cell">
                     <asp:TextBox ID="rescom" runat="server" CssClass="MS_input_txt normal-input" MaxLength="100" placeholder="숙소 코멘트를 등록할 수 있습니다." TextMode="MultiLine"></asp:TextBox>
      ...
      <asp:TableCell>
            ...
            <asp:TableRow>
              <asp:TableCell>
                ...
                <asp:TableCell>
                         <asp:Button ID="Button1" runat="server" Text="수정" CssClass="skinbtn point2 l-login" ValidationGroup="member" BackColor="#fe5c24" BorderStyle="None" OnClick="Button1_Click"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <asp:Button ID="Button2" runat="server" Text="취소" CssClass="skinbtn point2 l-login" ValidationGroup="member" BackColor="#fe5c24" BorderStyle="None" OnClick="Button2_Click"/>
            </asp:TableCell>
        </asp:TableRow>
        </asp:Table>
