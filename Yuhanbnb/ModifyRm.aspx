<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyRm.aspx.cs" Inherits="ModifyRm" %>
...
<form id = "form1" runat="server"> 
    <div class="wrapper"><h1 style="color:black; text-align:center; margin-bottom:40px;"><a href="index.aspx"></a></h1>
        ...
        <asp:TableRow CssClass="borderTop">
            ...
            <asp:TableCell>
                 <div class="col-cell">
                     <asp:TextBox ID="RoomName" runat="server" CssClass="MS_input_txt normal-input" MaxLength="100" ></asp:TextBox>         
                </div>
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                ...
                <asp:Image ID="Image1" runat="server" ImageUrl = '<%# Eval("rmimg1") %>' Width ="200px" Height ="200px"/>
            </asp:TableCell>
        </asp:TableRow>
            ...
            <asp:TableCell>
                ...
                <asp:Image ID="Image2" runat="server" ImageUrl = '<%# Eval("rmimg1") %>' Width ="200px" Height ="200px"/>
            </asp:TableCell>
        </asp:TableRow>
            ...
            <asp:TableCell>
                ...
                <asp:Image ID="Image3" runat="server" ImageUrl = '<%# Eval("rmimg3") %>' Width ="200px" Height ="200px"/>
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableRow>
            ...
            <asp:TableCell>
                  <asp:TextBox ID="RoomPrice" runat="server" CssClass="MS_input_txt normal-input" Columns="40"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
        ...
        <asp:TableHeaderCell><div class="head-cell"><span class="empha"></span>방 코멘트</div></asp:TableHeaderCell>
            <asp:TableCell>
                 <asp:TextBox ID="RoomComment" runat="server"  width ="265px" Height ="100px" TextMode ="MultiLine" CssClass ="MS_input_txt normal-input"></asp:TextBox>
            </asp:TableCell>
        </asp:TableRow>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="section_tittle text-center">
                         <asp:Button ID="Button1" runat="server" Text="수정" CssClass="skinbtn point2 l-login" ValidationGroup="member" BackColor="#fe5c24" BorderStyle="None" /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;                       
